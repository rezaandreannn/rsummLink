           ...
           <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown" class="nav-link nav-link-lg message-toggle "><i class="fas fa-exchange-alt"></i></a>
               <div class="dropdown-menu dropdown-list dropdown-menu-right">
                   ...
                   <div class="dropdown-list-content dropdown-list-message">
                       ...
                       $routeExists = Route::has($app->prefix.'.dashboard');
                       @endphp
                       <a href="{{ $routeExists ? route($app->prefix.'.dashboard') : '' }}" class="dropdown-item dropdown-item-unread">
                           <div class="dropdown-item-desc">
                               <b>{{ ucwords($app->name)}}</b>
                               <div class="{{ $app->status == 'active' ? 'is-online' : '' }}"></div>
                               {{-- <p>{{ $app->status }}</p> --}}
                               <div class="time">{{$app->created_at->diffForHumans()}}</div>
                           </div>
                       </a>
                       @endforeach
                   </div>
