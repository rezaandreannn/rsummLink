...
@php
$menuItemsByMenuId = \App\Models\MenuItem::all()->groupBy('menu_id');
@endphp
    ...
    <div class="collapse navbar-collapse" id="navbar-menu">
        <div class="navbar">
            <div class="container-xl">
                <ul class="navbar-nav">
                    @foreach(\App\Models\Menu::where('is_superadmin', true)->get() as $menu)
                    <li class="nav-item {{ $menu->route == '' ? 'dropdown' : ''}}">
                        <a class="nav-link {{ $menu->route == '' ? 'dropdown-toggle' : ''}}" href="{{ $menu->route == '' ? '#navbar-'.$menu->id : $menu->route}}" @if ($menu->route == '')
                            ...
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                                ...
                                {!! htmlspecialchars_decode($menu->icon) !!}
                            </span>
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    ...
                                    <a class="dropdown-item" href="{{ $menuItem->route }}">
                                        {{ $menuItem->name }}
                                        @if($menuItem->is_new)
