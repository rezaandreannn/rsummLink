                        ...
                        <form action="{{ route('menu.update', $menu->id)}}" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <select id="icon" class="form-control select2" name="icon">
                                            ...
                                            <option value="{{ $icon->class }}" {{$menu->icon == $icon->class ? 'selected' : ''}}>{{$icon->label}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <select class="form-control selectric" name="application_id">
                                            ...
                                            <option value="{{ $app->id}}" {{ $menu->application_id == $app->id ? 'selected' : ''}}>{{$app->name}}</option>
                                            @endforeach
                                            <option value="0" {{ $menu->application_id == 0 ? 'selected' : ''}}>super admin</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <select class="form-control" name="permission_id">
                                            ...
                                            <option value="{{ $permission->id}}" {{ $menu->application_id == $permission->id ? 'selected' : ''}}>{{$permission->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="number" class="form-control" name="serial_number" value="{{ $menu->serial_number}}">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
