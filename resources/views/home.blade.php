...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center">
            ...
            <a href="index.html" class="logo d-flex align-items-center me-auto">
                ...
                <h2 class="sitename">RsummLink</h2>
            </a>

            <nav id="navmenu" class="navmenu">
                <ul>
                    <li><a href="#hero" class="">Home</a></li>
                    {{-- <li><a href="#about">Ab\out</a></li> --}}
    ...
    <main class="main">
            ...
            <div class="container">
                <div class="row gy-4">
                    <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="zoom-out">
                        <h1 class="">Aplikasi Terintegrasi</h1>
                        <p class="">RsummLink Adalah aplikasi revolusioner yang menghubungkan Anda dengan layanan kesehatan yang beragam dari berbagai penyedia dalam satu platform yang mudah digunakan.</p>
                        <div class="d-flex">
        ...
        {{-- <section id="team" class="team section">
            ...
            <div class="container section-title" data-aos="fade-up">
                <h2>Team</h2>
                <p>Kolaborasi yang baik meningkatkan produktivitas tim dan menghasilkan solusi yang lebih baik.</p>
            </div><!-- End Section Title -->
    ...
    <footer id="footer" class="footer">
        ...
        <div class="container copyright text-center mt-4">
            <p>© <span>Copyright</span> <strong class="px-1 sitename">RSU Muhammadiyah Metro</strong> <span>All Rights Reserved</span></p>
            <div class="credits">
